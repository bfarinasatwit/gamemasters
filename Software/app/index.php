...
<body class="text-center">
  ...
  <div class="cover-container d-flex h-100 p-3 mx-auto flex-column">
    ...
    <main role="main" class="inner cover">
      ...
      <button type="button" class="btn btn-secondary" onclick="window.location.href='survey.html'">
        Get Started!
      </button>
    </main>
  ...
  <script src="Cover%20Template%20for%20Bootstrap_files/jquery-3.2.1.slim.min.js"
